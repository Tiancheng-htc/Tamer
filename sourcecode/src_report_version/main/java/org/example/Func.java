...
public class Func
{
    ...
    public int funcLen;
    public static boolean report_flag = true;         // The flag of report function
    public static float final_verify_score = 0.65f;
    public static float report_score = 0.4f;
    ...
    public double Caculate_similarity_of_Func(Func another) throws IOException
    {
        ...
        file_res += Integer.toString(this.funcId);
        file_res += "_";
        file_res += Integer.toString(another.funcId);;
        ...
        for (int i = 0; i <= 9; i++)
        {
            ...
            for (int j = 0; j < A_onetypeSubtree_number; j++)
            {
                ...
                for (int k = 0; k < B_onetypeSubtree_number; k++)
                {
                    ...
                    double report_len = longestCommonSubsequence(a, b);
                    similar_cal = (double) report_len / (double) (a.length() + b.length() - report_len);
